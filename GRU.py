# !/usr/bin/env python
# title           :GRU
# description     :GRU Model That Predicts Closing Price of Stock at T+1
# author          :Juan Maldonado
# date            :5/2/19
# version         :1.0
# usage           :python3 GRU.py
...
layers = [tf.contrib.rnn.GRUCell(num_units=num_neurons, activation=tf.nn.leaky_relu) for layer in range(num_layers)]
...
plt.title('GRU : MSE  Tst: %.6f / Vld: %.6f | Epochs : %d | LRate : %.3f | Nrns: %d | Lyrs : %d | BSize : %d' %
...
figure.savefig('GRU/GRUBestConfig' + '.png')